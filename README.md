...
- **Performance:** otimização de assets de vídeo e carregamento para manter a fluidez das animações mesmo em páginas com mídia pesada.
- **Responsividade:** layout e animações adaptados para diferentes tamanhos de tela, do desktop ao mobile.
- **Design executivo:** paleta, tipografia e ritmo visual pensados para transmitir sofisticação e confiança.
...
O projeto está **ao vivo** e hospedado via **Netlify**, garantindo deploy contínuo, alta disponibilidade e entrega otimizada de assets.

🔗 [https://zenith-aviacao.netlify.app/](https://zenith-aviacao.netlify.app/)

---

## 💻 Como Rodar Localmente

Para explorar o projeto no seu ambiente local, siga os passos abaixo:

```bash
# 1. Clone o repositório
git clone https://github.com/seu-usuario/zenith-aviacao.git
...
Pronto! O projeto abrirá automaticamente no navegador com hot-reload ativado.
...
├── js/
│   └── main.js           # Animações GSAP/ScrollTrigger
└── assets/
    ├── jet-v7-web.mp4   # Vídeo de fundo em tela cheia
    └── poster.jpg        # Poster/fallback do vídeo
```
...
Desenvolvido com atenção aos detalhes de UX, performance e storytelling visual, unindo código limpo a uma experiência de navegação memorável.
